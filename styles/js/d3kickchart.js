...
d3.csv("kick.csv", function (data){
    ...
    var headers = ["Japan","Korea","Singapore","Germany","United Kingdom","Canda","United States","Austraila","France"];
    ...
    var color = d3.scale.ordinal()
        .domain(headers)
        .range(["#fe6673", "#fbb8ac", "#fad8be", "#e3c887", "#e6e2c3", "#bdf3d4","#cbf5fb","#acf6ef","#a2e1d4"]);
